...
namespace ArePeopleWearing.Tests.BeingWornControllerTests
{
    ...
    public class GetShould
    {
        ...
        {
            var result = _controller.IsBeingWorn(string.Empty, "-39.801,87.302").Result;
        ...
        {
            var result = await _controller.IsBeingWorn("sundress", coordinates);
        ...
        {
            var result = await _controller.IsBeingWorn("sundress", "-39.801,87.302");
